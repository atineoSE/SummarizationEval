...
python LLM.py --model mixtral_8x7b_instruct --file ./transcripts/awesome_nature_64.csv --batch_size 64 &> ./out/mixtral_64_64.out
python LLM.py --model mixtral_8x7b_instruct --file ./transcripts/awesome_nature_100.csv --batch_size 100 &> ./out/mixtral_100_100.out
...
python LLM.py --model llama2_70b_chat --file ./transcripts/awesome_nature_64.csv --batch_size 64 &> ./out/llama2_64_64.out
python LLM.py --model llama2_70b_chat --file ./transcripts/awesome_nature_100.csv --batch_size 100 &> ./out/llama2_100_100.out
